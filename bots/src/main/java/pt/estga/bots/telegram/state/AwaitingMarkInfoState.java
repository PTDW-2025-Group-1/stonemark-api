...
public class AwaitingMarkInfoState implements ConversationState {
    ...
    public BotApiMethod<?> handleTextMessage(ConversationContext context, String messageText) {
        // Title is autogenerated, so we only need the description
        MarkOccurrenceProposal proposal = proposalFlowService.proposeMark(context.getProposalId(), "Auto-generated Title", messageText);
    ...
    public BotApiMethod<?> handleSkipCommand(ConversationContext context) {
        // User skipped adding a description
        MarkOccurrenceProposal proposal = proposalFlowService.proposeMark(context.getProposalId(), "Auto-generated Title", null);
        context.setProposal(proposal);
        context.setState(stateFactory.createState(proposal.getStatus()));
        return messageFactory.createMessageForProposalStatus(context.getChatId(), proposal);
    }
