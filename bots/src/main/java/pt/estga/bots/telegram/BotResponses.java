...
public class BotResponses {
    ...
    public static final String AWAITING_MARK_DETAILS = "Please send the title and description for the new mark, separated by a newline (e.g., 'Title\\nDescription').";
    ...
    public static final String INVALID_MARK_DETAILS_FORMAT = "Invalid format. Please send the title and description separated by a newline (e.g., 'Title\\nDescription').";
}
