...
import pt.estga.chatbots.core.features.proposal.commands.ProposeNewMonumentCommand;
...
public class ProposeNewMonumentCommandHandler implements CommandHandler<ProposeNewMonumentCommand> {

    private final Cache<String, ConversationContext> conversationContexts;

    @Override
    public BotResponse handle(ProposeNewMonumentCommand command) {
        ...
        return BotResponse.builder()
                .uiComponent(Menu.builder().title("What is the name of the new monument?").build())
                .build();
    }
}
